...
$(".card-wrap-grid .grid-row:nth-child(n+4) .grid-button img").attr("loading", "lazy");

$(".row-category p").click(function() {
$(this).parent(".row-category").parent(".grid-row").toggleClass("show");
});
